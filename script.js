...
orderBtn.addEventListener(
    ...
    async function () {
        ...
        document.getElementById("summaryPages").textContent = data.pages;

        document.getElementById("summaryType").textContent =
            data.type === "color" ? "Colour" : "Black & White";

        document.getElementById("summaryCopies").textContent = data.copies;

        document.getElementById("summaryTotal").textContent = data.total;

        orderStatus.textContent = "🟡 Order Pending";

        // --- NEW CHANGES (Hiding main form card & button) ---
        const mainCard = document.querySelector(".main-form-card");
        if (mainCard) mainCard.style.display = "none";
        
        orderBtn.style.display = "none"; // Continue Button hide karein

        // Summary View Show karein
...
editBtn.addEventListener(
    ...
    function () {
        ...
        orderBtn.disabled = !shopOnline || selectedFiles.length === 0;
...
calculateTotal();reateElement("small");
